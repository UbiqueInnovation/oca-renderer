...
#let oca = parseOca("style_test.oca")
#set page(width: auto, height: auto, margin: 1pt, fill: rgb(0,0,0,0))
#card(json.decode("{\"vc\" : { \"givenName\" : \"Manfred\", \"surname\" : \"Mustermann\", \"dateOfBirth\" : \"20001010\" }}"), oca)
